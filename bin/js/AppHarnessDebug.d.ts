...
declare module tests.unit.geom {
    class Matrix3DTest extends unit.tsUnit.TestClass {
        constructor();
...
declare module tests.unit.geom {
    class Vector3DTest extends unit.tsUnit.TestClass {
        public construct(): void;
