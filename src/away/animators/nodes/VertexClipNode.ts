...
module away.animators
{
	...
	{
		private _frames:Array<away.base.Geometry> = new Array<away.base.Geometry>();
		private _translations:Array<away.geom.Vector3D> = new Array<away.geom.Vector3D>();

		/**
		 * Returns a vector of geometry frames representing the vertex values of each animation frame in the clip.
		 */
		public get frames():Array<away.base.Geometry>
		{
			return this._frames;
		}
		...
		public _pUpdateStitch()
		{
			...
			var p1:away.geom.Vector3D, p2:away.geom.Vector3D, delta:away.geom.Vector3D;
			while (i--) {
