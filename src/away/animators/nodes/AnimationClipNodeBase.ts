...
module away.animators
{
    ...
    export class AnimationClipNodeBase extends AnimationNodeBase
    {
        ...
        public _pDurations:Array<number> = new Array<number>(); /*uint*/
        public _pTotalDelta:away.geom.Vector3D = new away.geom.Vector3D();
        ...
        public get totalDelta():away.geom.Vector3D
        {
            if (this._pStitchDirty)
                this._pUpdateStitch();
