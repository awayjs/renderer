...
module away.materials
{
	...
	export class DiffuseCelMethod extends DiffuseCompositeMethod
	{
		...
		constructor(levels:number /*uint*/ = 3, baseMethod:DiffuseBasicMethod = null)
		{
			...
			baseMethod._iModulateMethod = (vo:MethodVO, target:ShaderRegisterElement, regCache:ShaderRegisterCache, sharedRegisters:ShaderRegisterData) => this.clampDiffuse(vo, target, regCache, sharedRegisters);
