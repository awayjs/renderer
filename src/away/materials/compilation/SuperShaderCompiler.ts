...
module away.materials
{
	...
	export class SuperShaderCompiler extends ShaderCompiler
	{
		...
		public pInitLightData()
		{
			...
			this._pointLightRegisters = new Array<ShaderRegisterElement>(this._pNumPointLights*3);
			this._dirLightRegisters = new Array<ShaderRegisterElement>(this._pNumDirectionalLights*3);
		}
		 ...
		 */
		private compileTangentVertexCode(matrix:Array<ShaderRegisterElement>)//Vector.<ShaderRegisterElement>)
		{
			this._pSharedRegisters.tangentVarying = this._pRegisterCache.getFreeVarying();
			...
			this._pVertexCode += "m33 " + temp + ".xyz, " + this._pSharedRegisters.animatedNormal + ", " + matrix[0] + "\n" +
								 ...
								 "m33 " + temp + ".xyz, " + this._pSharedRegisters.animatedTangent + ", " + matrix[0] + "\n" +
