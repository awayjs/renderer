...
//------------------------------------------------------------------------------------------------
var GeomTests = (function () {
    function GeomTests() {
        this.geomBase = new away.base.SubGeometryBase();
        this.geom = new away.base.Geometry();
        this.sgeom = new away.base.SubGeometry();
        this.cgeom = new away.base.CompactSubGeometry();
    ...
    GeomTests.prototype.onContextCreated = function (e) {
        away.Debug.log('onContextCreated', e);
    };

    GeomTests.prototype.onContextReCreated = function (e) {
        away.Debug.log('onContextReCreated', e);
    };

    GeomTests.prototype.onContextDisposed = function (e) {
...
//@ sourceMappingURL=GeomTests.js.map
