...
class TextureMultiPassMatTest
{
    ...
    private init()
    {
        ...
        var ts : away.textures.HTMLImageElementTexture = new away.textures.HTMLImageElementTexture( this.pngLoader.image );

        var mat : away.materials.TextureMultiPassMaterial = new away.materials.TextureMultiPassMaterial( ts );
...
var test: TextureMultiPassMatTest;
window.onload = function ()
{
    test = new TextureMultiPassMatTest();
}
