...
export class RendererPool implements IAbstractionPool {
	...
	constructor(renderGroup: RenderGroup, rendererClass: IRendererClass) {
		this.id = AbstractionBase.ID_COUNT++;
		this.renderGroup = renderGroup;
		this._rendererClass = rendererClass;
		this.materialClassPool = rendererClass.materialClassPool;
	}
